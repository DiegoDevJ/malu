    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-purple-50 to-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-16 text-purple-800 fade-up">Nossos Serviços</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className={`bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow fade-up stagger-delay-${i + 1}`}>
      ...
      <section id="contato" className="py-20 px-4 bg-gradient-to-t from-purple-50 to-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-16 text-purple-800 fade-up">Nossa Localização</h2>
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="w-full h-[400px] rounded-lg overflow-hidden shadow-lg fade-up stagger-delay-1">
              <iframe
      ...
      <footer className="bg-purple-900 text-white py-8">
        <div className="max-w-6xl mx-auto px-4 text-center fade-up">
